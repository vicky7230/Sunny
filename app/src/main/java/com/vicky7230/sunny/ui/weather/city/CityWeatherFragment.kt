...
import com.vicky7230.sunny.utils.AppConstants
...
class CityWeatherFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(city: String): CityWeatherFragment {
            val bundle = Bundle()
            bundle.putString(AppConstants.CITY, city)
    ...
    override fun onCreateView(
        ...
        cityWeatherViewModel = ViewModelProviders.of(
            this,
            viewModelFactory
    ...
    override fun setUp(view: View) {
        ...
        city?.let {
            ...
            compositeDisposable.add(
                cityWeatherViewModel.getForecastData(
                    city
                )
                    .subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
